...
class Admin_Silver extends CI_Controller {
	...
	{
		$data['silver'] = $this->Admin_Silver_model->get_silver();
		$this->load->view('admin_Silver',$data);
	}

	public function export()
    {
        $this->phpexcel->setActiveSheetIndex(0);
        $this->phpexcel->getActiveSheet()->setTitle('Booking Silver Member');

        $users = $this->Admin_Silver_model->export();
        ...
        $filename= 'Booking Silver Member.xls'; //save our workbook as this file name
  ...
  function hapus1($kode_booking){
    ...
    $this->Admin_Silver_model->hapus_data($where,'peminjaman_ruang');
    redirect('Admin_Silver');
  }
}
