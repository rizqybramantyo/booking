...
class User_BronzeRegistration extends CI_Controller {
	...
	public function index()
	{
		...
		$data['nama'] = null;
		$data['nohp'] = null;
		$this->load->view('user_BronzeRegistration',$data); //, array('error'=> ' ')
	...
	public function registrasi(){
		...
		if ( ! $this->upload->do_upload('scan')){
			...
			$this->load->view('User_BronzeRegistration', $error);
		}else{
		...
		if ($cekemail_peminjam->num_rows() == null) {
			...
			$this->User_Registration_model->bronze($user_data);
		...
		//	$data['scan'] = null;
			...
			$data['pass'] = null;
		//	$data['scan'] = $scan;
			$this->load->view('user_BronzeRegistration',$data);
		}
	}
