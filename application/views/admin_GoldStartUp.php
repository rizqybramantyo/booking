...
<head>
  ...
  <title>Booking Room | Admin Gold Start Up</title>
    ...
    <section class="content">
      ...
      <!-- Button Daftar PUI -->
        ...
        <div class="col-lg-2 col-xs-6">
          <a href="<?php echo base_url('admin_GoldStartUp/export'); ?>">
                    ...
                    <tr>
                      ...
                      <td>
                         ...
                         <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modalview-<?php echo $item->kode_booking; ?>"><i class="glyphicon glyphicon-eye-open"></i></button>
                          ...
                          <div class="btn-group">  
                          <a href = " <?php echo 
                          base_url('Admin_GoldStartUp/hapus1/'.$item->kode_booking); ?>"><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete"><i class="glyphicon glyphicon-trash"></i></button></a>
                    </div>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control" name="jam_mulai" >
                    </div>
                </div>
                <div class="form-group">
                    <label>End Date:</label>
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control" name="jam_selesai" >
                    </div>
                </div>
                <div class="form-group">
                    <label>Start Time:</label>
