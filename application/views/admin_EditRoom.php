          ...
          <div class="row">
           <section class="content">
            <div class="box box-default">
              <div class="box-body" >
              <form role="form" action="<?php echo base_url(); ?>Admin_Room/store_ubah" method="POST">
                   <input style="display: none;" type="text" name="id_ruang" value="<?php echo $ruang->id_ruang ?>"> 
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="nama_ruang"  value="<?php echo $ruang->nama_ruang; ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="input-group-addon">
                         ...
                         <input type="text" class="form-control" name="kapasitas"  value="<?php echo $ruang->kapasitas ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="fasilitas"  value="<?php echo $ruang->fasilitas ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Size" name="ukuran"  value="<?php echo $ruang->ukuran ?>">
                    </div>
                </div>
                <div class="form-group">
                      <label>Image :</label>
                          <div class="input-group">
                              <input type="file" id="exampleInputFile" name="foto"   value="<?php echo $ruang->foto ?>" required>
