...
<head>
  ...
  <title>Booking Room | Bronze Registration</title>
  ...
  <div class="content-wrapper">
    <div class="container">
        <div class="box">
            <div class="row">
                <div class="col-md-12">
                <div class="small-box" style="background-color: #cd7f32; margin-left: 10px; margin-top: 10px; margin-right: 10px;">
                  <div class="inner">
                    <h3>Bronze</h3>
            ...
            <div class="row" style="background-color: #cd7f32; margin-left: 10px; margin-right: 10px;">
            &nbsp;
            <div class="col-md-12">
                <div class="box box-warning">
                    <div class="box-body">
                      <form method="post" action="<?php echo base_url('user_BronzeRegistration/registrasi')?>" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="NIK / SIM / Passport" name="no_identitas" required="" value="<?php if($no_identitas != null){echo $no_identitas;}?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Unit Name/Individu Name:</label>
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-pencil"></i>
                                </div>
                                <input type="text" class="form-control" placeholder="Name" name="nama_instansi" required="" value="<?php if($nama_instansi != null){echo $nama_instansi;}?>">
                            </div>
                        </div>
                        <div class="form-group">
