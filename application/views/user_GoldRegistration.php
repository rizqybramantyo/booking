...
<head>
  ...
  <title>Booking Room | Gold Registration</title>
        ...
        <div class="box">
            ...
            <div class="col-md-12">
                <div class="box box-warning">
                    <div class="box-body">
                      <form method="post" action="<?php echo base_url('user_GoldRegistration/registrasi')?>">

                        <div class="form-group">
                            <label>ID Number Leader Start Up:</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Start Up Name" name="nama_instansi" required="" value="<?php if($nama_instansi != null){echo $nama_instansi;}?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Leader Start Up Name:</label>
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-pencil"></i>
                                </div>
                                <input type="text" class="form-control" placeholder="Name Leader" name="nama" required="" value="<?php if($nama != null){echo $nama;}?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Member 1" name="anggota1" required="" value="<?php if($anggota1 != null){echo $anggota1;}?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Member 2" name="anggota2"  value="<?php if($anggota2 != null){echo $anggota2;}?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Email:</label>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" style="text-align: center;">
          ...
          <h4>Selamat, Registrasi berhasil !</h4>
          <h5>Silahkan login</b></h5>
        </div> 
