...
<head>
  ...
  <title>Booking Room | Admin Member Gold</title>
  ...
  <div class="content-wrapper">
    ...
    <!-- Tampilan untuk mendefinisikan jumlah pengguna -->
      ...
      <!-- Jumlah Pengguna Silver -->
        <form method="post" action="<?php echo base_url('Admin_MemberGold');?>">
          <div class="col-md-12">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-xs-6">
          <a href="<?php echo base_url('Admin_MemberGold/export'); ?>">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php $i=0; foreach ($peminjam as $item){ $i++; ?>
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                        <a href = " <?php echo base_url('Admin_MemberGold/hapus1/'.$item->id_penyewa); ?>"><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete"><i class="glyphicon glyphicon-trash"></i></button></a>
                      </div>
                      </td>
                    </tr>
                    <?php
  ...
  <div class="modal modal-default fade" id="modal-<?php echo $item->id_penyewa; ?>" >
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form method="post" action="<?=base_url()?>Admin_MemberGold/ubahKataSandiPeminjam" data-toggle="validator">
     ...
     <!--    <div class="modal modal-default fade" id="modal-delete">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a href="<?php echo base_url('admin_memberGold'); ?>">
