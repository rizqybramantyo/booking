...
<head>
  ...
  <title>Booking Room | Admin Gold PUI</title>
  ...
  <div class="content-wrapper">
          ...
          <div>
            ...
            ?>
                <div class="alert alert-success fade in">
                  ...
                  Added PUI Register <strong>Successfully!</strong>
                </div>
            ...
            ?>
                <div class="alert alert-danger fade in">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  Added PUI Register <strong>Failed !</strong> 
                </div>
    ...
    <section class="content">
      ...
      <!-- Button Daftar PUI -->
        ...
        <i class="fa fa-user-plus"></i> Add PUI </a>
         
        </div>
        <div class="col-lg-7 col-xs-6"></div>
        <div class="col-lg-2 col-xs-6">
          <a href="<?php echo base_url('admin_GoldPUI/export'); ?>">
                      ...
                      <td>
                        <div class="btn-group">
                         <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modalview-<?php echo $item->kode_booking; ?>"><i class="glyphicon glyphicon-eye-open"></i></button>
                          ...
                          <div class="btn-group">  
                          <a href = " <?php echo 
                          base_url('Admin_GoldPUI/hapus1/'.$item->kode_booking); ?>"><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete"><i class="glyphicon glyphicon-trash"></i></button></a>
                    </div>
                      </td>
                    </tr>
                  <?php
...
<!--modal add PUI-->
   <div class="modal fade" id="modal-add">
     <form method="post" action="<?php echo base_url('admin_GoldPUI/addPui')?>" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                <div class="box box-primary">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Name" name="nama_instansi" required="">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" placeholder="Insert 'EDS' for password without quotes ! " name="pass" required="">
                    </div>
                  </div>
                  </div>
                  </form>
...
<div class="modal fade" id="modalview-<?php echo $item->kode_booking; ?>">
    <form method="post" action="<?php echo base_url('admin_GoldPUI');?>"> 
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
