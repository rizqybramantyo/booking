...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "Data tidak ditemukan" )
		{
		...
		var searchFn = function() {
			...
			if ( val != previousSearch.sSearch ) {
				_fnFilterComplete( settings, {
					"sSearch": val,
					"bRegex": previousprevious.bRegex,
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Tampilkan _START_ to _END_ of _TOTAL_ entries",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Tampilkan 0 to 0 of 0 entries",
